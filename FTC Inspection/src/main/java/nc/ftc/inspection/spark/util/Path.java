...
public class Path {
    ...
    public static class Web {
        ...
        public static final String SET_OVERLAY_DEFAULT = "/event/:event/settings/overlay/";
        ...
        public static final String GET_TIME = "event/:event/time/";
        ...
        public static final String STATS = "/event/:event/stats/";
    ...
    public static class Template {
		...
		public static final String EVENT_SETTINGS = "/velocity/event/eventSettings.vm";
    }
